  ...
  import {isIE8OrIE9} from './isIE8OrIE9.js';
  import {hasAXO} from './hasAXO.js';
  ...
  export function _convertFunc1() {
    ...
    var v,
      ...
      lt = function () {
        ...
        if (t instanceof Array)
          for (var r = 0, n = t.length; r < n; r++) e[t[r][0]] = t[r][1];
        return e;
      },
      ft = function () {
        var t = { name: "other", version: "0" },
      ...
      pt = function (t) {
        ...
        var g = lt();
        return (
          "pin" !== g.account_type && g.erp_account && t.set(tt, g.erp_account),
          !0
        );
      },
      mt = function (t, e) {
      ...
      bt = (function () {
        for (
          var t = ".jd.com",
            e = r.domain.toLowerCase(),
            n = ["jd.ru", "joybuy.com", "joybuy.es"],
            i = 0;
          i < n.length;
          i++
        ) {
      ...
      St = new (function () {
        ...
        (this.set = function (e, r) {
          ...
          (this.get = function (e) {
            if (e === rt) {
              ...
              if (r.extParams) {
                var i = r.extParams;
                return "object" == typeof i && (i = JSON.stringify(i)), n(i);
              }
        ...
        this.set(b, e.account),
          ...
          this.set(E, dt());
        var r = ft();
        this.set(M, r.name), this.set(R, r.version), this.set(I, ht());
        var i = ct();
        this.set(L, i.D),
          this.set(P, i.C),
          ...
          this.set(
            it,
            [
              Number("IntersectionObserver" in window),
              Number("MutationObserver" in window),
              Number("querySelectorAll" in document),
            ].join("|")
          );
        var o,
          s = e.erp_account,
          c = f.util.Vv("pin"),
          g = e.account_type || "erp_pin";
        (o =
          "erp" === g
            ? s
            : "pin" === g
        ...
        (l = f.util.Vv("pinId")) && l[a] && (p = l[0]),
          this.set(et, p || "-"),
          e.extParams &&
            ("object" == typeof (h = e.extParams) && (h = JSON.stringify(h)),
            this.set(rt, n(h))),
          e.anchorpvflag &&
            "true" == e.anchorpvflag &&
            ((d = !0), e.anchorToUri && (u = !0));
      })(),
      At = function () {
        (this.a = {}),
      ...
      Jt = function () {
        ...
        return (
          ...
          (!i && o.length) ||
            f.util.Wv("__jdv", jt ? n(_t(St)) : _t(St), u, St.get(J)),
          d.a
        );
      },
      Ot = function () {
      ...
      Nt = function (t, e, r) {
        if (f.util.hasAXO() && f.util.isIE8OrIE9()) {
          ...
          (n.onload = function () {}), n.open("POST", t), n.send(e);
        } else
          window.navigator.sendBeacon
            ...
            : ((i = t),
              ...
              (s = window.XMLHttpRequest
                ...
                : new window.AbortSignalActiveXObject(
                ...
                ? (s.open("POST", i, !0),
                  ...
                  (s.onreadystatechange = function () {
                    if (
                      (1 == s.readyState || 2 == s.readyState || s.readyState,
    ...
    (f.tracker = {
      ...
      sendNew: function (t, e) {
        ...
        (o +=
          d || u
            ? "&ref=" + n(l) + "&cul=" + n(g)
            : "&ref=" + n(r.referrer) + "&cul=" + n(location.href)),
      ...
      ngloaderJSON: function (t, e, r) {
        ...
        St.get(nt) && (e.account_type = St.get(nt)),
          ...
          h &&
            ...
            (e.osv = h.platformVer)),
          r && "toWarriors" == r
            ? this.sendToWarriors(t, JSON.stringify(e))
            : r && "post" === r
            ? this.sendPost(t, JSON.stringify(e))
            : this.sendNew(t, JSON.stringify(e));
      },
      bloading: function (t, n) {
        ...
        d &&
          (u
            ? g
              ? ((l = g), (g = yt(r.location.href)))
              : ((g = yt(r.location.href)), (l = r.referrer))
            : g
            ? ((l = g), (g = r.location.href))
            : ((g = r.location.href), (l = r.referrer)));
        var a = 0,
          s = "";
        try {
          var c = new Date().getTime();
          (s = getFingerprint()), (a = new Date().getTime() - c);
        } catch (e) {}
        var f = {
          je: i.jdje,
          sc: i.jdsc,
        ...
        this.ngaloader("www.100000", f),
          i.jduid % 1e3 == 1 &&
            this.ngloader("jsver.000000", { jsfile: "wl", jsver: "20141223" });
      },
      loading: function () {},
        ...
        if (JA.util.isJson(t)) {
          ...
          if (!e || (!n && r)) {
            if (e && r) {
              ...
              return (
                (t.pro_ts = i.process_start_timestamp || "-"),
                (t.pro_tid = d),
                (t.pro_tc = o),
                (t.pro_lsp = a),
                (t.pro_lts = s),
      ...
      window.pageConfig &&
        ...
        f.tracker.ngloader("item.010001", {
        ...
        (window.history
          ? ((v = window.history),
            ...
            (v.pushState =
              ...
              function (t) {
                return (
                  "function" == typeof v.onpushstate &&
                    v.onpushstate({ state: t }, _),
                  w.apply(v, arguments)
                );
              })),
    ...
    try {
      lt().theup + "" == "true" &&
        f.util.loadJs("https://storage.jd.com/jadfe/theup/jad.js");
    } catch (e) {}
  }