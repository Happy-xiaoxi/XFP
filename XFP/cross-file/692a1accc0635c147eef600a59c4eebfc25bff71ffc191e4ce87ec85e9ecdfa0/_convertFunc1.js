  ...
  return (
    (e.prototype = {
      ...
      jsFontsKey: function (e, t) {
        ...
        return setTimeout(function () {
          ...
          for (var g = 0, p = a.length; g < p; g++)
            (l[a[g]] = d[g].offsetWidth), (h[a[g]] = d[g].offsetHeight);
          var f = (function () {
            for (var e = {}, t = 0, i = r.length; t < i; t++) {
              for (var n = [], o = 0, l = a.length; o < l; o++) {
                var h = c(r[t], a[o]);
                s.appendChild(h), n.push(h);
              }
              e[r[t]] = n;
            }
            return e;
          ...
          n.appendChild(s);
          for (var m = [], S = 0, T = r.length; S < T; S++)
            (function (e) {
              for (
                var t = !1, i = 0;
                i < a.length &&
                !(t =
                  e[i].offsetWidth !== l[a[i]] ||
                  e[i].offsetHeight !== h[a[i]]);
                i++
              );
              return t;
            })(f[r[S]]) && m.push(r[S]);
      ...
      getAdBlock: function () {
        ...
        (e.innerHTML = "\xa0"), (e.className = "adsbox");
        var t = !1;
        try {
        ...
        return (
          ...
          !!(
            (("ontouchstart" in window ||
              ...
              "Other" !== e) ||
            (void 0 !== i &&
              (((i = i.toLowerCase()).indexOf("win") >= 0 &&
                "Windows" !== e &&
                "Windows Phone" !== e) ||
                (i.indexOf("linux") >= 0 && "Linux" !== e && "Android" !== e) ||
                (i.indexOf("mac") >= 0 && "Mac" !== e && "iOS" !== e) ||
                (0 === i.indexOf("win") &&
                  0 === i.indexOf("linux") &&
                  i.indexOf("mac") >= 0 &&
                  "other" !== e)))
      ...
      getHasLiedBrowser: function () {
        ...
        if (
          (37 === n && "Safari" !== e && "Firefox" !== e && "Other" !== e) ||
          (39 === n && "Internet Explorer" !== e && "Other" !== e) ||
          (33 === n && "Chrome" !== e && "Opera" !== e && "Other" !== e)
        )
          return !0;
        try {
          throw "a";
