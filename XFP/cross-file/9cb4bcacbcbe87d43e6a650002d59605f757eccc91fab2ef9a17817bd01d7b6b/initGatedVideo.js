...
export function initGatedVideo() {
    ...
    if ('undefined' == typeof jQuery && 'undefined' == typeof MauticJS.mauticInsertedScripts.jQuery) {
        MauticJS.insertScript('https://sangfor.huoyan.cn/app/bundles/CoreBundle/Assets/js/libraries/2.jquery.js');
    ...
    if ('undefined' == typeof Froogaloop && 'undefined' == typeof MauticJS.mauticInsertedScripts.Froogaloop) {
        MauticJS.insertScript('https://sangfor.huoyan.cn/assets/js/froogaloop2.min.js');
    ...
    if ('undefined' == typeof jQuery || 'undefined' == typeof Froogaloop) {
        ...
        MauticJS.insertStyle('https://sangfor.huoyan.cn/media/css/mediaelementplayer.min.css');
        var mejs = mejs || {};
        mejs.version = '2.21.2', mejs.meIndex = 0, mejs.plugins = {
            silverlight: [{
                    version: [
                        3,
                        0
            ...
            calculateTimeFormat: function (a, b, c) {
                ...
                var d = b.timeFormat, e = d[0], f = d[1] == d[0], g = f ? 2 : 1, h = ':', i = Math.floor(a / 3600) % 24, j = Math.floor(a / 60) % 60, k = Math.floor(a % 60), l = Math.floor((a % 1 * c).toFixed(3)), m = [
                        [
                            l,
                            'f'
                        ],
            ...
            return c(a, b, 0, 1), c(a, b, 1, 1), c(a, b, 2, 10000), c(a, b, 2, 1000), c(a, b, 2, 100), c(a, b, 2, 10), c(a, b, 2, 1), c(a, b, 3, 1), b;
        }), mejs.MediaFeatures = {
            init: function () {
                var a, b, c = this, d = document, e = mejs.PluginDetector.nav, f = mejs.PluginDetector.ua.toLowerCase(), g = [
                        'source',
                        'track',
                        'audio',
                        'video'
            ...
            createPlugin: function (a, b, c, d, e, f) {
                ...
                case 'youtube':
                    ...
                    -1 != a.url.lastIndexOf('youtu.be') ? (r = a.url.substr(a.url.lastIndexOf('/') + 1), -1 != r.indexOf('?') && (r = r.substr(0, r.indexOf('?')))) : r = a.url.substr(a.url.lastIndexOf('=') + 1), youtubeSettings = {
                        ...
                        width: k,
                        scheme: a.scheme
                    }, window.postMessage ? mejs.YouTubeApi.enqueueIframe(youtubeSettings) : mejs.PluginDetector.hasPluginVersion('flash', [
                        10,
                        0,
                        0
                ...
                case 'vimeo':
                    var s = m + '_player';
                    if (n.vimeoid = a.url.substr(a.url.lastIndexOf('/') + 1), o.innerHTML = '<iframe tabindex="-1" src="' + a.scheme + 'player.vimeo.com/video/' + n.vimeoid + '?api=1&portrait=0&byline=0&title=0&player_id=' + s + '" width="' + k + '" height="' + l + '" frameborder="0" class="mejs-shim" id="' + s + '" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>', 'function' == typeof $f) {
                        var t = $f(o.childNodes[0]), u = -1;
                        t.addEvent('ready', function () {
                            ...
                            }), n.pluginElement = o, n.pluginApi = t, n.success(n, n.pluginElement);
                        });
                    } else
            ...
            createFlash: function (a) {
                ...
                var b, c = a.scheme + 'www.youtube.com/apiplayer?enablejsapi=1&amp;playerapiid=' + a.pluginId + '&amp;version=3&amp;autoplay=0&amp;controls=0&amp;modestbranding=1&loop=0&disablekb=1';
                    ...
                    if (!f.created) {
                        if (f.created = !0, f.media = b, f.domNode = c, !(g.isAndroid && f.options.AndroidUseNativeControls || g.isiPad && f.options.iPadUseNativeControls || g.isiPhone && f.options.iPhoneUseNativeControls)) {
                            ...
                            f.container.trigger('controlsready'), f.setPlayerSize(f.width, f.height), f.setControlsSize(), f.isVideo && (mejs.MediaFeatures.hasTouch ? f.$media.bind('touchstart', function () {
                                ...
                                f.controlsEnabled && (f.media.paused || f.options.alwaysShowControls || f.startControlsTimer(1000));
                ...
                buildfullscreen: function (b, c, d, e) {
                    if (b.isVideo) {
                        ...
                        var f = this, g = null, h = a('<div class="mejs-button mejs-fullscreen-button"><button type="button" aria-controls="' + f.id + '" title="' + f.options.fullscreenText + '" aria-label="' + f.options.fullscreenText + '"></button></div>').appendTo(c).on('click', function () {
                                ...
                                'plugin-hover' == f.fullscreenMode && (null !== g && (clearTimeout(g)), g = setTimeout(function () {
                ...
                enterFullScreen: function () {
                    ...
                    return mejs.MediaFeatures.hasiOSFullScreen ? void b.media.webkitEnterFullscreen() : (a(document.documentElement).addClass('mejs-fullscreen'), b.normalHeight = b.container.height(), b.normalWidth = b.container.width(), 'native-native' === b.fullscreenMode || 'plugin-native' === b.fullscreenMode ? (mejs.MediaFeatures.requestFullScreen(b.container[0]), b.isInIframe && setTimeout(function c() {
                        if (b.isNativeFullScreen) {
                            var d = 0.002, e = a(window).width(), f = screen.width, g = Math.abs(f - e), h = f * d;
                            g > h ? b.exitFullScreen() : setTimeout(c, 500);
                        }
                    }, 1000)) : 'fullwindow' == b.fullscreeMode, b.container.addClass('mejs-container-fullscreen').width('100%').height('100%'), b.containerSizeTimeout = setTimeout(function () {
                        b.container.css({
                            width: '100%',
                            height: '100%'
                        }), b.setControlsSize();
                        ...
                        for (var c, d, e, f = 0, g = mejs.TrackFormatParser.split2(b, /\r?\n/), h = {
                            ...
                            if (c = this.pattern_timecode.exec(g[f]), c && f < g.length) {
                                for (f - 1 >= 0 && '' !== g[f - 1] && (e = g[f - 1]), f++, d = g[f], f++; '' !== g[f] && f < g.length;)
                                    d = d + '\n' + g[f], f++;
                                d = a.trim(d).replace(/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi, "''''"), h.text.push(d), h.times.push({
                                    identifier: e,
                                    start: 0 === mejs.Utility.convertSMPTEtoSeconds(c[1]) ? 0.2 : mejs.Utility.convertSMPTEtoSeconds(c[1]),
                ...
                dfxp: {
                    parse: function (b) {
                        ...
                        for (e = 0; e < g.length; e++) {
                            ...
                            k && (l.style = k), 0 === l.start && (l.start = 0.2), i.times.push(l), d = a.trim(g.eq(e).html()).replace(/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi, "''''"), i.text.push(d), 0 === i.times.start && (i.times.start = 2);
                        }
                        return i;
                    }
                },
                ...
                renderContextMenu: function (b, c) {
                    for (var d = this, e = '', f = d.options.contextMenuItems, g = 0, h = f.length; h > g; g++)
                        if (f[g].isSeparator)
                            ...
                            var i = f[g].render(d);
                            null != i && (e += '<div class="mejs-contextmenu-item" data-itemindex="' + g + '" id="element-' + 1000000 * Math.random() + '">' + i + '</div>');
                        }
