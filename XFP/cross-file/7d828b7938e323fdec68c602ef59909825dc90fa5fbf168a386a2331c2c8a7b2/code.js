...
import {fetchRtusResponseAndStoreItInLocalStorage} from './fetchRtusResponseAndStoreItInLocalStorage.js';
...
var criteoCallback = function () {
  console.log("criteoCallback");
}
  window.GUM_DOMAIN = "gum.criteo.com";
  window.CONFIG_CSM_DOMAIN_NAME = "csm.jp2.as.criteo.net";
  window.CALLER_ID = "147";
  window.CONFIG_JS_CALLBACK = criteoCallback;
  ...
  function setCookieOnMainDomain(e, t, n, o) {
  ...
  var _a,
    ...
    syncframe = new RtusSyncframe(
      {
        ...
        onSyncframeResponseHandled: function () {
          ...
          logElapsedTime(
            ...
            fetchRtusResponseAndStoreItInLocalStorage(t, n, o, r)
              .then(function () {
                logElapsedTime(
    ...
    function getRtusResponseFromLocalStorage() {
      return (
