...
export function getIPs(n) {
    var i, o, u, t;
    try {
        var f = {}, r = window.RTCPeerConnection || window.mozRTCPeerConnection || window.webkitRTCPeerConnection, e = !!window.webkitRTCPeerConnection;
        ...
        t.createOffer(function (n) {
            t.setLocalDescription(n, function () {
            }, function () {
            });
        }, function () {
        });
